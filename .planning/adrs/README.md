...
All ADRs use the [MADR 4.0.0](https://adr.github.io/madr/) format. See [adr-template.md](adr-template.md) for the template and [ADR-0001](0001-adr-process.md) for conventions on when and how to write an ADR.
