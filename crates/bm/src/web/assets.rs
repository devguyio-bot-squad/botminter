...
/// Returns `true` if the console has at least `index.html` embedded,
/// meaning the frontend was built before the Rust binary was compiled.
pub fn console_has_assets() -> bool {
